...
$__System.registerDynamic("6", ["3"], true, function(req, exports, module) {
  ;
  var global = this,
    ...
    var Mask = function(el, mask, options) {
      ...
      var p = {
        ...
        getMCharsBeforeCount: function(index, onCleanVal) {
          for (var count = 0,
              i = 0,
              maskL = mask.length; i < maskL && i < index; i++) {
...
$__System.registerDynamic("8", [], false, function(__require, __exports, __module) {
  ...
  (function() {
    ...
    var btnSelect = this["btnSelect"];
    var hdnInput = this["hdnInput"];
    ...
    (($, root) => {
      ...
      class Plugin {
        ...
        _events() {
          this.el.on("click", ".btn-select", $.proxy(this.openList, this)).on("click", ".select-list", $.proxy(this.closeList, this)).on("click", ".option-item", $.proxy(this.handleOption, this));
        }
        openList(e) {
  ...
  return {
    ...
    execute: function() {
      $__export('default', function() {
        ...
        return ($traceurRuntime.createClass)(Menu, {
          initialize: function() {
            this._events();
          },
          _events: function() {
  ...
  return {
    ...
    execute: function() {
      $__export('default', function() {
        ...
        return ($traceurRuntime.createClass)(Confirm, {
          initialize: function() {
            this._events();
          },
          _events: function() {
            this.buttons.on("click", $.proxy(this.handleButton, this));
            this.el.on("click", $.proxy(this.handleClose, this)).on("click", ".confirm-button", $.proxy(this.handleDelete, this));
          },
  ...
  return {
    ...
    execute: function() {
      $__export('default', function() {
        ...
        return ($traceurRuntime.createClass)(StatusPanel, {
          initialize: function() {
            this._events();
          },
          _events: function() {
...
$__System.register("1", ["3", "5", "7", "8", "9", "a", "b"], function($__export) {
  "use strict";
  var __moduleName = "1";
  var $,
      validate,
  ...
  return {
    setters: [function($__m) {
      ...
      validate = $__m.default;
    }, function($__m) {
      mask = $__m.default;
    }, function($__m) {
      selectify = $__m.default;
    }, function($__m) {
      Menu = $__m.default;
    }, function($__m) {
      Confirm = $__m.default;
...
//# sourceMappingURL=staff.bundle.js.map